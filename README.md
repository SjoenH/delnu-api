...
[![Build Status](https://travis-ci.org/SjoenH/delnu-api.svg?branch=master)](https://travis-ci.org/SjoenH/delnu-api)
...
6. If you did everything correct, https://sjoenh.github.io/delnu-api/ will lead to your new docs
...
- Documentation(ReDoc): https://sjoenh.github.io/delnu-api/
- SwaggerUI: https://sjoenh.github.io/delnu-api/swagger-ui/
- Look full spec:
    + JSON https://sjoenh.github.io/delnu-api/swagger.json
    + YAML https://sjoenh.github.io/delnu-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://sjoenh.github.io/delnu-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://sjoenh.github.io/delnu-api/ with url from the message: `Server started <url>`
